...
{
	if (LimenPlayerCharacter.IsValid())
	{
		LimenPlayerCharacter.Reset();
	}
...
void ALimenPlayerController::RequestNotificationPause(const bool bWantsToPause)
{	
	if (bWantsToPause)
	{
		OnPauseRequested.Broadcast(this, EPauseReason::Notification);
	}
	else
	{
